    ...
    <div class="container-fluid w-75">
        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                foreach ($product->getData('cart') as $cart_item) :
                    // get full product details for each cart item
                    $cart_product = $product->getProduct($cart_item['item_id']);
                    $subTotal[] = array_map(function ($item) use ($Cart) {
                ?>
                <!-- cart item -->
                ...
                <?php
                    ...
                    }, $cart_product); // closing array_map function
                endforeach;
                ?>
            </div>
            <!-- subtotal section-->
                ...
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-baloo font-size-20">
                            ...
                            <span class="text-danger">$<span id="deal-price"><?php echo isset($subTotal) ? $Cart->getSum($subTotal) : 0; ?></span></span>
                        </h5>
